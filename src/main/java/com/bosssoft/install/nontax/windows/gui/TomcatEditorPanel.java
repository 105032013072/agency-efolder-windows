...
public class TomcatEditorPanel extends AbstractASEditorPanel implements ActionListener,FocusListener{
	...
	void jbInit() throws Exception {
		...
		this.lblTCHome.setBounds(new Rectangle(0, 6, 90, 16));
		
		this.tcHomeChooser.setBounds(new Rectangle(117, 4, 253, 21));
		this.tcHomeChooser.setButtonText(I18nUtil.getString("BUTTON.BROWSE2"));
		
		
		this.lblTCPort.setText("Tomcat Port:");
		this.lblTCPort.setBounds(new Rectangle(0, 33, 90, 16));
		this.txPort.setBounds(new Rectangle(117, 30, 215, 22));
	...
	public Properties getProperties() {
		...
		p.put("IS_APP_SERVER_INSTALL", false);
		return p;
	}
