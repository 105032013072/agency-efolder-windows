...
public class FrontDigestPanel extends AbstractSetupPanel {
	...
	private void loadTree() {
		...
		Map<String,ResourceDef> resourceMap=	ResourceDefHelper.getResourceMap();//加载需要安装的运行组件
		labelNode = new DefaultMutableTreeNode(evnServers);
		this.treeModel.insertNodeInto(labelNode, root, root.getChildCount());
		for (String server : resourceMap.keySet()) {
