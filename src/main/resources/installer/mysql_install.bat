...
set dbname=%3
set pw=%4
set path=%SystemRoot%/system32;%SystemRoot%;%SystemRoot%;%path%
...
rem   echo  skip-grant-tables >> my.ini
echo  event_scheduler=ON >> my.ini
